...
$q="insert into appointment_request(`appoint_with`, `request_from`, `date`, `start_time`, `end_time`, `subject`,`ticket_id`, `qr_image`) VALUES  ('$email','$u_name','$date','$start_time','$end_time','$subject','$ticket_id','$file')";
